...
function PlayerListComponent() {
	...
	useEffect(() => {
		const inputConnection = UserInputService.InputBegan.Connect(
			(input, processed) => {
                    ...
                    */
							...
							return arr.map(([team, teamPlayers]: [Team | undefined, Player[]]) => (
								<frame
									...
									BackgroundColor3={
										team && team.TeamColor ? team.TeamColor.Color : new Color3(1, 1, 1)
									}
									AutomaticSize={Enum.AutomaticSize.Y}
									BorderSizePixel={0}
								>
